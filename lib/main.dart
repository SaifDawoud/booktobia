...
import 'package:booktobia/Features/home/presentation/manger/newest_books_cubit/newset_books_cubit.dart';
import 'package:booktobia/constants.dart';
...
void main() {
  setupServiceLocator();
  runApp(const Booktobia());
}

class Booktobia extends StatelessWidget {
  const Booktobia({super.key});
